...
Web App published with Git Hub Pages: https://jamdominguez.github.io/Angular-From_HTML_Template_to_WebApp/#/home <br><br>
...
- Crear interface: **ng g i nombreInterfaz interface**
...
- Para crear el componente "ng g c shared/header --spec=false", la ultima parte es para indicar que no se cree el fichero de pruebas unitarias, pero este argumento ha sido cambiado en version es de Angular posteriores al curso, ahora hay que usar "--skip-tests", por lo que el comando queda **ng g c shared/header --skip-tests**
<div align="center">
